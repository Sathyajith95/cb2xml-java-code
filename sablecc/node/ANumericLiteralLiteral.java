...
public final class ANumericLiteralLiteral extends PLiteral
{
    ...
    public ANumericLiteralLiteral(final TNumericLiteral numericLiteral) {
        this.setNumericLiteral(numericLiteral);
    }
    
    @Override
    public Object clone() {
        return new ANumericLiteralLiteral(this.cloneNode(this._numericLiteral_));
    }
    
    @Override
    public void apply(final Switch switch1) {
        ((Analysis)switch1).caseANumericLiteralLiteral(this);
    }
