...
public final class ANumberNot88Number extends PNumber
{
    ...
    public ANumberNot88Number(final TNumberNot88 numberNot88) {
        this.setNumberNot88(numberNot88);
    }
    
    @Override
    public Object clone() {
        return new ANumberNot88Number(this.cloneNode(this._numberNot88_));
    }
    
    @Override
    public void apply(final Switch switch1) {
        ((Analysis)switch1).caseANumberNot88Number(this);
    }
