...
public final class ADataNameDataNameOrFiller extends PDataNameOrFiller
{
    ...
    public ADataNameDataNameOrFiller(final TDataName dataName) {
        this.setDataName(dataName);
    }
    
    @Override
    public Object clone() {
        return new ADataNameDataNameOrFiller(this.cloneNode(this._dataName_));
    }
    
    @Override
    public void apply(final Switch switch1) {
        ((Analysis)switch1).caseADataNameDataNameOrFiller(this);
    }
