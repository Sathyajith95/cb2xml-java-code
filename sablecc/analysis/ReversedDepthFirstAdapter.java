...
public class ReversedDepthFirstAdapter extends AnalysisAdapter
{
    ...
    public void caseAOccursClause(final AOccursClause aOccursClause) {
        ...
        final ArrayList<PIndexedByPhrase> list = new ArrayList<PIndexedByPhrase>(aOccursClause.getIndexedByPhrase());
        Collections.reverse(list);
        final Iterator<Object> iterator = list.iterator();
        while (iterator.hasNext()) {
            iterator.next().apply(this);
        }
        final ArrayList<Object> list2 = new ArrayList<Object>(aOccursClause.getAscendingOrDescendingKeyPhrase());
        Collections.reverse(list2);
        final Iterator<PAscendingOrDescendingKeyPhrase> iterator2 = list2.iterator();
    ...
    public void caseAAscendingOrDescendingKeyPhrase(final AAscendingOrDescendingKeyPhrase aAscendingOrDescendingKeyPhrase) {
        ...
        final ArrayList<TDataName> list = new ArrayList<TDataName>(aAscendingOrDescendingKeyPhrase.getDataName());
        Collections.reverse(list);
        final Iterator<Object> iterator = list.iterator();
        while (iterator.hasNext()) {
            iterator.next().apply(this);
    ...
    public void caseAIndexedByPhrase(final AIndexedByPhrase aIndexedByPhrase) {
        ...
        final ArrayList<TDataName> list = new ArrayList<TDataName>(aIndexedByPhrase.getDataName());
        Collections.reverse(list);
        final Iterator<Object> iterator = list.iterator();
        while (iterator.hasNext()) {
            iterator.next().apply(this);
